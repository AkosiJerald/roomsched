...
function filterByRoom(room) {
    ...
    console.log("Filtering by room: " + selectedRoomNumber);  // Use selectedRoomNumber here, not roomNumber

    fetch(`../php/fetch_rooms.php?room=${room}`)
        ...
        .then(data => {
            if (data.success) {
                ...
                if (roomHeader) {
                    ...
                    console.warn('No roomHeader element found.');
                }
            } else {
